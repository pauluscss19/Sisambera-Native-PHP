    ...
    <div class="content-wrapper" style="grid-template-columns: 1fr;">
        <div class="confirmation-content">
            ...
            <div class="upload-section">
                <p>Silakan upload bukti pembayaran Anda untuk memverifikasi transaksi</p>
                <p style="font-size: 11px; margin-bottom: 20px;">File harus dalam format JPG, PNG atau PDF (Max 5MB)</p>
                ...
                <form action="ajax/upload_bukti.php" method="POST" enctype="multipart/form-data" id="uploadForm">
                    ...
                    <input type="file" name="bukti_bayar" id="bukti_bayar" accept="image/*,.pdf" style="display: none;" onchange="uploadBukti()">
                    <button type="button" class="upload-btn" onclick="document.getElementById('bukti_bayar').click()">
                        📎 Pilih File
                    </button>
                    <div id="uploadStatus" style="margin-top: 15px; font-size: 12px;"></div>
                </form>
            </div>
            <?php endif; ?>
...
function uploadBukti() {
    ...
    .then(data => {
        if (data.success) {
            status.innerHTML = '✅ Bukti pembayaran berhasil diupload!';
